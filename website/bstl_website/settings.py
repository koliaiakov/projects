"""
Django settings for bstl_website project.
...
PROJECT_DIR = os.path.join(BASE_DIR, "bstl_website")
...
ROOT_URLCONF = 'bstl_website.urls'
...
WSGI_APPLICATION = 'bstl_website.wsgi.application'
